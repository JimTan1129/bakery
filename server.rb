...
zebra = Muffin.new("Yeezy-V2", "Take your shoes home", "$24.99", "https://scontent-atl3-1.cdninstagram.com/vp/dbbfc55979690fd06bfdea78f0ffa643/5D9948D7/t51.2885-15/e35/16585514_261124854298597_4817039107907649536_n.jpg?_nc_ht=scontent-atl3-1.cdninstagram.com")
mag = Muffin.new("Air-Mag", "Back To the Future!", "$34.99", "https://pmcfootwearnews.files.wordpress.com/2017/01/nike-mag-eat-good-nyc-cupcake.jpg")
yay = Muffin.new("Yeezy 750", "Make America Great Again", "$34.99", "http://eatgood.nyc/wp-content/uploads/2015/05/kanyewest.png")
...
def send_email(rec)
  News.letter.welcome(rec).deliver_now
end
